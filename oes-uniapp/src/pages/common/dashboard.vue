  ...
  <view class="dashboard">
    ...
    <view class="stats-grid">
      ...
      <template v-if="userInfo.role === 'ADMIN'">
        ...
        <view class="stat-card" @click="goTo('/pages/admin/user-manage?role=STUDENT')">
          <view class="stat-icon admin-icon">
            <uni-icons type="contact-filled" size="24" color="#fff" />
          </view>
          <view class="stat-info">
        ...
        <view class="stat-card" @click="goTo('/pages/admin/user-manage?role=TEACHER')">
          <view class="stat-icon admin-icon">
            <uni-icons type="staff-filled" size="24" color="#fff" />
          </view>
          <view class="stat-info">
      ...
      <template v-else-if="userInfo.role === 'TEACHER'">
        <view class="stat-card" @click="goTo('/pages/teacher/my-classes')">
          <view class="stat-icon teacher-icon">
            <uni-icons type="folder-filled" size="24" color="#fff" />
          </view>
          <view class="stat-info">
        ...
        <view class="stat-card" @click="goTo('/pages/teacher/paper-manage')">
          <view class="stat-icon teacher-icon">
            <uni-icons type="paperclip" size="24" color="#fff" />
          </view>
          <view class="stat-info">
        ...
        <view class="stat-card" @click="goTo('/pages/teacher/question-manage')">
          <view class="stat-icon teacher-icon">
            <uni-icons type="help" size="24" color="#fff" />
          </view>
          <view class="stat-info">
        ...
        <view class="stat-card" @click="goTo('/pages/teacher/exam-manage')">
          <view class="stat-icon teacher-icon">
            <uni-icons type="calendar-filled" size="24" color="#fff" />
          </view>
          <view class="stat-info">
      ...
      <view class="card">
        <view class="card-header">
          <view class="card-title">
            <uni-icons type="file-text" size="20" color="#dc2626" />
    ...
    <template v-if="userInfo.role === 'TEACHER'">
      <view class="card">
        <view class="card-header">
          <view class="card-title">
            <uni-icons type="calendar-filled" size="20" color="#dc2626" />
    ...
    <template v-if="userInfo.role === 'STUDENT'">
      <view class="card">
        <view class="card-header">
          <view class="card-title">
            <uni-icons type="clock" size="20" color="#dc2626" />
      ...
      <view class="card tips-card">
        <view class="card-header">
          <view class="card-title">
            <uni-icons type="info" size="20" color="#dc2626" />
...
import { examApi, examRecordApi, statisticsApi, logApi } from '../../utils/api'
