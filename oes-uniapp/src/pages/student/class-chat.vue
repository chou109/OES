          ...
          <view class="message-content-wrapper">
            ...
            <view class="exam-notice" v-else>
              <view class="notice-header">
                ...
                <text class="notice-title">{{ parseExamNotice(msg.content)?.title }}</text>
              ...
              <view class="notice-info">
                <view class="info-item">
                  ...
                  <text>{{ parseExamNotice(msg.content)?.startTime }}</text>
                </view>
                <view class="info-item">
                  <text class="info-icon">{{ iconEnd }}</text>
                  <text>{{ parseExamNotice(msg.content)?.endTime }}</text>
                </view>
                <view class="info-item">
                  <text class="info-icon">{{ iconTimer }}</text>
                  <text>{{ parseExamNotice(msg.content)?.duration }}分钟</text>
                </view>
              </view>
